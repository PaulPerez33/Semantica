...
namespace Semantica
{
    public class Lexico : Token
    {
        ...
        {
            linea = 1;
            string path = "C:\\Users\\paul-\\OneDrive\\Escritorio\\Lenguajes y Automatas II\\Semantica\\prueba.cpp";
            bool existencia = File.Exists(path);
            log = new StreamWriter("C:\\Users\\paul-\\OneDrive\\Escritorio\\Lenguajes y Automatas II\\Semantica\\prueba.Log"); 
            log.AutoFlush = true;
